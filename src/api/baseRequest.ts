...
const scopes = ["user-library-read", "playlist-read-private",'user-follow-read','ugc-image-upload','playlist-modify-private','playlist-modify-public','user-follow-modify'];
